...
const BlogEdit = () => {
  ...
  if (loading) {
    return <div className="blog-form-loading">Loading post data...</div>
  }
    ...
    <div className="blog-form-container">
      ...
      <form onSubmit={handleSubmit} className="blog-form">
        ...
        <div className="form-group">
          ...
          {imagePreview ? (
            <div className="image-preview-container">
              ...
              <p className="image-preview-note">New image selected</p>
            </div>
          ) : currentImage ? (
            <div className="image-preview-container">
        ...
        <div className="form-actions">
          <button type="button" onClick={() => navigate(`/blog/${id}`)} className="btn-secondary">
            Cancel
          </button>
